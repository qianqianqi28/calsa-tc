...
write.csv(lsarawaveragelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\average linkage\\lsarawaveragelinkage.csv")
# lsarawaverage.averagelinkage.accuracy <- average.averagelinkage.accuracy
# write.csv(lsarawaverage.averagelinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\average linkage\\lsarawaverage.averagelinkage.accuracy.csv")
# 

lsarawsinglelinkage <- singlelinkage_kfold
write.csv(lsarawsinglelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\single linkage\\lsarawsinglelinkage.csv")

# lsarawaverage.singlelinkage.accuracy <- average.singlelinkage.accuracy
# write.csv(lsarawaverage.singlelinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\single linkage\\lsarawaverage.singlelinkage.accuracy.csv")



lsarawcompletelinkage <- completelinkage_kfold
write.csv(lsarawcompletelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\complete linkage\\lsarawcompletelinkage.csv")
# lsarawaverage.completelinkage.accuracy <- average.completelinkage.accuracy
# write.csv(lsarawaverage.completelinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\complete linkage\\lsarawaverage.completelinkage.accuracy.csv")


lsarawcentroidlinkage <- centroidlinkage_kfold
write.csv(lsarawcentroidlinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\centroid linkage\\lsarawcentroidlinkage.csv")
# lsarawaverage.centroidlinkage.accuracy <- average.centroidlinkage.accuracy
# write.csv(lsarawaverage.centroidlinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\centroid linkage\\lsarawaverage.centroidlinkage.accuracy.csv")
