...
for (n in 1:length(testing_dtm)){
  ...
  dimdefi <- max(dimdefi, rankMatrix(training_dtm.SR))
}
...
write.csv(carawaveragelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\average linkage\\carawaveragelinkage.csv")
# carawaverage.averagelinkage.accuracy <- average.averagelinkage.accuracy
# write.csv(carawaverage.averagelinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\average linkage\\carawaverage.averagelinkage.accuracy.csv")


carawsinglelinkage <- singlelinkage_kfold
write.csv(carawsinglelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\single linkage\\carawsinglelinkage.csv")

# carawaverage.singlelinkage.accuracy <- average.singlelinkage.accuracy
# write.csv(carawaverage.singlelinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\single linkage\\carawaverage.singlelinkage.accuracy.csv")
# 


carawcompletelinkage <- completelinkage_kfold
write.csv(carawcompletelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\complete linkage\\carawcompletelinkage.csv")
# carawaverage.completelinkage.accuracy <- average.completelinkage.accuracy
# write.csv(carawaverage.completelinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\complete linkage\\carawaverage.completelinkage.accuracy.csv")


carawcentroidlinkage <- centroidlinkage_kfold
write.csv(carawcentroidlinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\centroid linkage\\carawcentroidlinkage.csv")
# carawaverage.centroidlinkage.accuracy <- average.centroidlinkage.accuracy
# write.csv(carawaverage.centroidlinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\centroid linkage\\carawaverage.centroidlinkage.accuracy.csv")
