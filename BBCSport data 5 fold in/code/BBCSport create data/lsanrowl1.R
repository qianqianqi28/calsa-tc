#For section 5.3 of the first paper: this code is to calculate accuracy about LSA-NROWL1
...
dtm.training.lsanrowl1.svd.list <- list()
for (n in 1:length(testing_dtm)) {
  dtm.training.lsanrowl1.svd.list[[n]] <- svd(training_dtm[[n]])
}
...
for (n in loo.len){
  ...
  dtm.training.lsanrowl1.svd <- dtm.training.lsanrowl1.svd.list[[n]]
  
  td.mat_mfi_choose.train <- as.matrix(dtm.training.lsanrowl1.svd$u)%*%as.matrix(diag(dtm.training.lsanrowl1.svd$d))
  test_new_matrix.svd.ud <- as.matrix(testing_dtm[[n]]) %*% as.matrix(dtm.training.lsanrowl1.svd$v)
...
lsanrowl1averagelinkage <- averagelinkage_kfold
write.csv(lsanrowl1averagelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\average linkage\\lsanrowl1averagelinkage.csv")
# lsanrowl1average.averagelinkage.accuracy <- average.averagelinkage.accuracy
# write.csv(lsanrowl1average.averagelinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\average linkage\\lsanrowl1average.averagelinkage.accuracy.csv")


lsanrowl1singlelinkage <- singlelinkage_kfold
write.csv(lsanrowl1singlelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\single linkage\\lsanrowl1singlelinkage.csv")

# lsanrowl1average.singlelinkage.accuracy <- average.singlelinkage.accuracy
# write.csv(lsanrowl1average.singlelinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\single linkage\\lsanrowl1average.singlelinkage.accuracy.csv")



lsanrowl1completelinkage <- completelinkage_kfold
write.csv(lsanrowl1completelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\complete linkage\\lsanrowl1completelinkage.csv")
# lsanrowl1average.completelinkage.accuracy <- average.completelinkage.accuracy
# write.csv(lsanrowl1average.completelinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\complete linkage\\lsanrowl1average.completelinkage.accuracy.csv")


lsanrowl1centroidlinkage <- centroidlinkage_kfold
write.csv(lsanrowl1centroidlinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\centroid linkage\\lsanrowl1centroidlinkage.csv")
# lsanrowl1average.centroidlinkage.accuracy <- average.centroidlinkage.accuracy
# write.csv(lsanrowl1average.centroidlinkage.accuracy, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\BBCSport data 5 fold in\\created data\\centroid linkage\\lsanrowl1average.centroidlinkage.accuracy.csv")
# 
