#For section 5.3 of the first paper: this code is for 737 documents from five categories using five-fold cross validation. Note each time the documents from the training set form a nrowl1 document-term matrix and the documents of validation set are not included in the matrix.
