#For section 6.3 of the first paper: this code is to calculate accuracy about LSA-RAW
...
write.csv(lsarawaveragelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\Leave one out after supervisor\\Wilhelmus data Peter\\created data\\average linkage\\lsarawaveragelinkage.csv")


lsarawsinglelinkage <- average.singlelinkage.accuracy
write.csv(lsarawsinglelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\Leave one out after supervisor\\Wilhelmus data Peter\\created data\\single linkage\\lsarawsinglelinkage.csv")



lsarawcompletelinkage <- average.completelinkage.accuracy
write.csv(lsarawcompletelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\Leave one out after supervisor\\Wilhelmus data Peter\\created data\\complete linkage\\lsarawcompletelinkage.csv")


lsarawcentroidlinkage <- average.centroidlinkage.accuracy
write.csv(lsarawcentroidlinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\Leave one out after supervisor\\Wilhelmus data Peter\\created data\\centroid linkage\\lsarawcentroidlinkage.csv")
