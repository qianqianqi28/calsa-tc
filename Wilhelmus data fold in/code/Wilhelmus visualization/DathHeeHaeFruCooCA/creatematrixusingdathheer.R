#For Figure 8 of section 6.2 of the first paper: this code is about creating raw document-term matrix for songs from two authors Datheen and Heere and creating the vector about the Wilhelmus. Note the Wilhelmus is not included in the matrix.
...
mfi <- 300;
include_authors=c('datheen', 'heere')
x <- {}
author_len <- {}
...
save(training_dtm, testing_dtm,author_datheen.vector,  author_marnix.vector,file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\Wilhelmus data fold in\\figure\\Wilhelmus visualization\\DathHeeHaeFruCooCA\\rawmatrixdathheer.Rdata")
