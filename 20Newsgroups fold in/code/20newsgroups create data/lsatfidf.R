...
load("C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\20Newsgroups fold in\\created data\\created matrix\\tfidfdtm20newsgroups.Rdata")
...
dtm.training.lsatfidf.svd <- svd(training_dtm)

td.mat_mfi_choose.train <- as.matrix(dtm.training.lsatfidf.svd$u)%*%as.matrix(diag(dtm.training.lsatfidf.svd$d))
test_new_matrix.svd.ud <- as.matrix(testing_dtm) %*% as.matrix(dtm.training.lsatfidf.svd$v)
...
lsatfidfaveragelinkage <- average.averagelinkage.accuracy
write.csv(lsatfidfaveragelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\20Newsgroups fold in\\created data\\average linkage\\lsatfidfaveragelinkage.csv")

lsatfidfsinglelinkage <- average.singlelinkage.accuracy
write.csv(lsatfidfsinglelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\20Newsgroups fold in\\created data\\single linkage\\lsatfidfsinglelinkage.csv")



lsatfidfcompletelinkage <- average.completelinkage.accuracy
write.csv(lsatfidfcompletelinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\20Newsgroups fold in\\created data\\complete linkage\\lsatfidfcompletelinkage.csv")


lsatfidfcentroidlinkage <- average.centroidlinkage.accuracy
write.csv(lsatfidfcentroidlinkage, file ="C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 1\\20220417 Review 2 archive\\20Newsgroups fold in\\created data\\centroid linkage\\lsatfidfcentroidlinkage.csv")
